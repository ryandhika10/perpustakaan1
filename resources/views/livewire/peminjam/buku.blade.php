            ...
            <div class="col-md-4">
                <label class="visually-hidden" for="autoSizingInputGroup">Username</label>
                    <div class="input-group mb-3">
                        <input wire:model="search" type="text" class="form-control" id="autoSizingInputGroup" placeholder="Cari Buku">
                            <div class="input-group-text">
                                <button class="fa-solid fa-magnifying-glass border-0"></button>
                            </div>
                    </div>
            </div>
        @endif
                ...
                @foreach ($buku as $item)
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div wire:click="detailBuku({{ $item->id }})" class="card mb-4 shadow" style="cursor: pointer">
                            <img src="/storage/{{ $item->sampul }}" class="card-img-top" alt="{{ $item->judul }}" width="50" height="350">
                            <div class="card-body">
