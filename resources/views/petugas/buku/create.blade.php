                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="kategori_id" wire:click="pilihKategori" type="number" class="form-control" id="kategori">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="penerbit_id" type="number" class="form-control" id="penerbit">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="rak_id" type="number" class="form-control" id="rak">
